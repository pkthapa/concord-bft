...
class Client {
 public:
  ...
  void setTransactionSigner(concord::util::cryptointerface::ISigner* signer) { transaction_signer_.reset(signer); }
 ...
 private:
  ...
  std::unique_ptr<concord::util::cryptointerface::ISigner> transaction_signer_;
